...
namespace Proto
{
    public abstract class BookService<Context>
    {
        ...
        public delegate IEnumerator<UniTask<Book>> QueryBooks(QueryBooksRequest request, Context context);
        ...
        public static void RegisterService(RpcServerPort<Context> port, GetBook getBook, QueryBooks queryBooks)
        {
            ...
            result.streamDefinition.Add("QueryBooks",
                (payload, context) =>
                {
                    return ProtocolHelpers.SerializeMessageEnumerator(
                        queryBooks(QueryBooksRequest.Parser.ParseFrom(payload), context));
                });
