...
var util_1 = __nccwpck_require__(901);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var plugin_pb_1 = __nccwpck_require__(211);
var WellKnown_1 = __nccwpck_require__(618);
var FieldTypes_1 = __nccwpck_require__(529);
var util_1 = __nccwpck_require__(901);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var querystring_1 = __nccwpck_require__(477);
var parameters_1 = __nccwpck_require__(160);
...
const Printer_1 = __nccwpck_require__(283);
const common_1 = __nccwpck_require__(106);
const shared_1 = __nccwpck_require__(79);
function generateDclRpcService(filename, descriptor, exportMap) {
    return [(0, common_1.createFile)(generateClientTypeScriptDefinition(descriptor, exportMap), `Client${filename}Service.gen.cs`)];
}
exports.generateDclRpcService = generateDclRpcService;
function getCallName(method) {
...
function generateClientTypeScriptDefinition(fileDescriptor, exportMap) {
    ...
    const removePseudoName = (text) => {
        return (0, shared_1.removePseudoNameFromImportDescriptor)(text, serviceDescriptor.imports);
    };
...
// file: ${serviceDescriptor.filename}`);
    ...
    // Import statements.
    printer.printLn(`using Cysharp.Threading.Tasks;
using rpc_csharp;`);
  ...
  public ${className}(RpcClientModule module)
  {
      this.module = module;
        ...
        service.methods.forEach((method) => {
            const responseType = (0, shared_1.convertTypeToCSharp)(removePseudoName(method.responseType));
            const requestType = (0, shared_1.convertTypeToCSharp)(removePseudoName(method.requestType));
...
function generateServerRpcService(filename, descriptor, exportMap) {
    ...
    if (code == null)
        return null;
    return [(0, common_1.createFile)(code, `${filename}Service.gen.cs`)];
}
...
public static class ${service.name}CodeGen
{
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.convertTypeToCSharp = exports.removePseudoNameFromImportDescriptor = void 0;
function removePseudoNameFromImportDescriptor(text, imports) {
    for (let i of imports) {
        text = text.replace(i.namespace + ".", '');
    }
    return text;
}
exports.removePseudoNameFromImportDescriptor = removePseudoNameFromImportDescriptor;
// Converts `Teleport.FromKernel.RequestTeleport`
// to `global::Teleport.Types.FromKernel.Types.RequestTeleport`
function convertTypeToCSharp(typeName) {
...
exports.convertTypeToCSharp = convertTypeToCSharp;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const ExportMap_1 = __nccwpck_require__(648);
const util_1 = __nccwpck_require__(901);
const plugin_pb_1 = __nccwpck_require__(211);
//import { generateDclRpcService } from "./codegen/client"
const server_1 = __nccwpck_require__(937);
const client_1 = __nccwpck_require__(866);
